...
import static com.pragma.powerup.usermicroservice.configuration.Constants.AGE_NOT_VALID_MESSAGE;
import static com.pragma.powerup.usermicroservice.configuration.Constants.PHONE_NOT_VALID_MESSAGE;
import static com.pragma.powerup.usermicroservice.configuration.Constants.DNI_NOT_VALID_MESSAGE;
...
public class ControllerAdvisor {
    ...
    @ExceptionHandler(UserInvalidAge.class)
    public ResponseEntity<Map<String, String>> userInvalidAge(
            UserInvalidAge userInvalidAge) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
                .body(Collections.singletonMap(RESPONSE_ERROR_MESSAGE_KEY, AGE_NOT_VALID_MESSAGE));
    }
    @ExceptionHandler(UserInvaliPhone.class)
    public ResponseEntity<Map<String, String>> userInvaliPhone(
            UserInvaliPhone userInvaliPhone) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
                .body(Collections.singletonMap(RESPONSE_ERROR_MESSAGE_KEY, PHONE_NOT_VALID_MESSAGE));
    }
    @ExceptionHandler(UserInvaliDni.class)
    public ResponseEntity<Map<String, String>> userInvaliDni(
            UserInvaliDni userInvaliPhone) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
                .body(Collections.singletonMap(RESPONSE_ERROR_MESSAGE_KEY, DNI_NOT_VALID_MESSAGE));
    }
